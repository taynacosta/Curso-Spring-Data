...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		while(system) {
			...
			case 2:
				...
				break;
			case 3:
				buscaFuncionarioContratacao(scanner);
				break;
			case 4:
	...
	private void buscaFuncionarioNome(Scanner scanner) {
		System.out.println("Qual o nome voce deseja pesquisar?");
	...
	private void buscaFuncionarioNomeSalarioMaiorData (Scanner scanner) {
        ...
        System.out.println("Qual data contratacao voce deseja pesquisar?");
        String data = scanner.next();
        LocalDate localDate = LocalDate.parse(data, formatter);
        
        System.out.println("Qual salario voce deseja pesquisar?");
	...
	private void buscaFuncionarioContratacao(Scanner scanner) {
		System.out.println("Qual data contratacao voce deseja pesquisar?");
        String data = scanner.next();
        LocalDate localDate = LocalDate.parse(data, formatter);
